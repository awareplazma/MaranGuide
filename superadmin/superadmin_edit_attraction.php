...
if ($row = $result->fetch_assoc()) {
    ...
    //$thumbnailPath = $row['attraction_thumbnails'] ?? '';
...
<body>
    ...
    <div class="dashboard-container">
        ...
        <form id="locationForm" class="form-card" action="superadmin_edit_attraction_process.php" method="POST" enctype="multipart/form-data">
